  ...
  return (
    <div className="space-y-5 max-w-7xl">
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black text-sm font-medium ml-auto">
      ...
      <div className="rounded-xl border border-white/[0.06] bg-[#111111] overflow-hidden">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/[0.04] text-[11px] text-zinc-500 uppercase">
              {["Name", "URL", "Description", "Accounts", "Apple App", "Added at", "Account Type", "Added by"].map((h) => (
        ...
        <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
          ...
          <p className="text-base font-semibold text-white mb-1">Create your first project</p>
          ...
          <button className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black text-sm font-medium">
            <Plus className="w-4 h-4" /> New Project
          </button>
        </div>
      </div>
